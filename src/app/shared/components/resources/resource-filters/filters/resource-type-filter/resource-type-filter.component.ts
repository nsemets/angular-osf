...
import { ResourceFiltersSelectors, SetResourceType } from '@shared/components/resources/resource-filters/store';
...
export class ResourceTypeFilterComponent {
  ...
  protected availableResourceTypes = this.#store.selectSignal(ResourceFiltersOptionsSelectors.getResourceTypes);
  protected resourceTypeState = this.#store.selectSignal(ResourceFiltersSelectors.getResourceType);
