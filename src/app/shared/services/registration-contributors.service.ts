...
export class RegistrationContributorsService implements IContributorsService {
  private readonly jsonApiService = inject(JsonApiService);

  getAllContributors(projectId: string): Observable<ContributorModel[]> {
    const baseUrl = `${environment.apiUrl}/registrations/${projectId}/contributors`;
  ...
  updateContributor(projectId: string, data: ContributorModel): Observable<ContributorModel> {
    const baseUrl = `${environment.apiUrl}/registrations/${projectId}/contributors/${data.userId}`;
  ...
  deleteContributor(projectId: string, userId: string): Observable<void> {
    const baseUrl = `${environment.apiUrl}/registrations/${projectId}/contributors/${userId}`;
